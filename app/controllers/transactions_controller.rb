class TransactionsController < ApplicationController
  ...
  def transfer
    ...
    Account.transaction do
      ...
      recipient_account = recipient.accounts.find_by(currency: account_params[:currency])
      recipient_account ||= Account.create(currency: account_params[:currency], user: recipient,
                                           amount: 0)
      ...
      create_transaction(recipient_account, deposit: true)
      render json: { sender_account: sender_account, recipient_account: recipient_account },
             status: :created
